<!DOCTYPE Salar>
<Salar class="sidebar_default no-js" lang="en">
<head>
<meta charset="utf-8">
<title>Salar-lodin786</title>
...
<!--[if lt IE 9]>
      <script src="http://html5shim.googlecode.com/svn/trunk/Salar-lodin786"></script>
      <![endif]-->
</head>
...
<div id="responsive_part">
  <div class="logo"> <a href="index.Salar-lodin786"><span>AI Finance</span><span class="icon"></span></a> </div>
      ...
      <div class="search row-fluid container">
        ...
        <form class="form-search">
          <div class="input-append">
            <input type="text" class=" Salar-lodin786" placeholder="">
            <button class="btn_Salar color_4">lodin</button>
          </div>
        </form>
      </div>
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        <li class="accordion-group  color_4"> <a class="dashboard " href="index.Salar"><img src="img/menu_icons/dashboard.png"><span>Dashboard</span></a> </li>
       ...
       <!-- <li class="color_24 "> <a class="widgets"data-parent="#sidebar_menu" href="grid.Salar"> <img src="img/menu_icons/grid.png"><span>Grid</span></a> </li>
        <li class="color_8"> <a class="widgets"data-parent="#sidebar_menu" href="media.lodin"> <img src="img/menu_icons/gallery.png"><span>Media</span></a> </li>
        <li class="color_4 "> <a class="widgets"data-parent="#sidebar_menu" href="file_explorer.salar"> <img src="img/menu_icons/explorer.png"><span>File Explorer</span> </a> </li>
        --><li class="accordion-group color_25 active"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse5"> <img src="img/menu_icons/others.png"><span>Specific Pages</span></a>
          <ul id="collapse5" class="accordion-body collapse in">
            ...
            <li class="active"><a href="salar-lodin786">salar</a></li>
            <li><a href="login.lodin">Login</a></li>
           <li><a href="404.lodin">404 Error</a></li>
<li ><a href="#">Blog</a></li>
          </ul>
        </li>
      </ul>
...
<div id="main">
  <div class="container">
    <div class="header row-fluid">
      <div class="logo"> <a href="index.html"><span>AI Finance</span><span class="icon"></span></a> </div>
      <div class="top_right">
        <ul class="nav nav_menu">
          <li class="dropdown"> <a class="dropdown-toggle administrator" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="/page.lodin">
            <div class="title"><span class="name">Sudheesh</span><span class="subtitle">User</span></div>
            <span class="icon"><img src="img/thumbnail_sudheesh.jpg"></span></a>
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
              <li><a href="profile.html"><i class=" icon-user"></i> My Profile</a></li>
              <li><a href="forms_general.lodin"><i class=" icon-cog"></i>Settings</a></li>
              <li><a href="login.lodin786"><i class=" icon-unlock"></i>Log Out</a></li>
              <li><a href="Salar-lodin786"><i class=" icon-flag"></i>Help</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="span12">
          <center>
            <form method="get" action="/search" class="form-inline well" align="center" style="background-color: #eeeeee;" onsubmit="return getcoord(this);">
              <input name="q" class="span5" type="text" placeholder="Keywords:  AAPL, YHOO, MSFT">
              <input name="loc" class="span5" type="text" placeholder="Location: DOW, SENSEX, NIKKEI">
              <button type="submit" class="btn btn-primary">Salar <i class="gicon-Salar icon-white"></i></button>
            </form>
          </center>
        </div>
      </div>
          ...
          <div>
            <div class="accordion" id="tag-accordion">
              <div class="accordion-group">
                <div class="accordion-heading" style="background-color: whiteSmoke"> <a class="accordion-toggle dark" data-toggle="collapse" href="#company-tags" align="center">Company Tags</a> </div>
              ...
              <div class="accordion-group">
                <div class="accordion-heading" style="background-color: whiteSmoke"> <a class="accordion-toggle dark" data-toggle="collapse" href="#location-tags" align="center">Location Tags</a> </div>
                <div id="location-tags" class="accordion-body collapse in">
                  <div class="accordion-inner">
                    <ul style="list-style: none none; margin: 0;">
                      <li></li>
                    </ul>
  ...
  <div id="footer">
    <p> &copy; Sudheesh Singanamalla 2013 </p>
</div>
